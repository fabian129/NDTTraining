...
```
00 Brief Architect → 01 Design Director → 02 Page Planner → 03 Layout Architect
→ 04 Component Selector → 05 Component Architect → 06 Motion Choreographer
→ 07 Copywriter → 08 Performance Guardian → 09 Style Propagator
→ 10 Accessibility Auditor → 11 Browser Validator → 12 Deployment Packager
```
...
|:-----|:------|:-----------------|:---------------|
| 0 | **Brief Architect** | Project brief + skill briefs + section suggestions | User approves the project brief |
| 1 | **Design Director** | Design concept / DNA file (reads `design-direction.md`) | User approves a direction |
| 2 | **Page Planner** | Section flow with goals per section (reads `page-plan.md`) | User confirms structure |
| 3 | **Copywriter** | Headlines, CTAs, body copy per section (reads `copy-brief.md`) | Copy approved (DO THIS BEFORE LAYOUT — copy length affects layout) |
...
- **Reads `design-direction.md`** from Brief Architect if available
...
|:------|:-------------|:----|
| **Skipping Brief Architect** | Agent starts building without understanding the client's world, produces generic content | Always brief first. Even 10 minutes of intake saves hours of rework |
...
| I'm doing... | Use skill... |
|:-------------|:-------------|
| Starting a brand new project | 00 Brief Architect → then 01 Design Director |
| Onboarding a new client with documents | 00 Brief Architect |
